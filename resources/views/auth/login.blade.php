...
<head>
    ...
    <meta property="og:title" content="BillieJeanRecors" />
...
<body id="kt_body" class="auth-bg">
                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-lg form-control-solid @error('email')
                                    is-invalid
                                    @enderror" type="text" name="email" autocomplete="off" />
                                <!--end::Input-->
                                @error('email')
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <!--end::Wrapper-->
                                <!--begin::Input-->
                                <input class="form-control form-control-lg form-control-solid" @error('password')
                                    is-invalid @enderror type="password" name="password" autocomplete="off" />
                                <!--end::Input-->
                                @error('password')
                                <div class="fv-plugins-message-container invalid-feedback">
                                    <div data-field="email" data-validator="notEmpty"><strong>{{ $message }}</strong>
    ...
    <script src="{{ asset('admin_files/assets/js/custom/authentication/sign-in/general.js') }}"></script>
