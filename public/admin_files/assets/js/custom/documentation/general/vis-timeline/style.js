    ...
    init: function () {
        ! function () {
            ...
            const e = (t, e) => {
                ...
                return i.classList.add("symbol", "symbol-circle", "symbol-30"), i.appendChild(s), n.appendChild(a), n.appendChild(i), n
            };
            var n = new vis.DataSet([{
                start: new Date(2010, 7, 23),
                content: e("Conversation", hostUrl + "/media/avatars/300-6.jpg")
            }, {
                start: new Date(2010, 7, 23, 23, 0, 0),
                content: e("Mail from boss", hostUrl + "/media/avatars/300-1.jpg")
            }, {
                ...
                content: e("Phone call", hostUrl + "/media/avatars/300-5.jpg")
            }, {
